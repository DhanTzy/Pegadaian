                        ...
                        <div class="dropdown-menu dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="drop2">
                            <div class="message-body">
                                ...
                                <div class="d-flex justify-content-center">
                                    <a href="#" class="btn btn-outline-danger my-2 d-block w-75"
                ...
                <nav class="mt-5">
                    <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu"
                        ...
                        @hasanyrole('admin|customer service')
                            @php
                                $isTransaksi = Route::is('transaksi.index', 'transaksi.create', 'transaksi.edit');
                        ...
                        @hasanyrole('admin')
                            <li
                                class="nav-item {{ Route::is('karyawan.index', 'karyawan.create', 'karyawan.edit', 'users.index', 'users.create', 'users.edit', 'karyawan.pekerjaan.index', 'karyawan.pekerjaan.create', 'karyawan.pekerjaan.edit') ? 'menu-open' : '' }}">
                                <a href="#"
